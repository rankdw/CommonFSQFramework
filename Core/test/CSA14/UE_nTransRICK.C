...
#define M_PI           3.14159265358979323846
  ...
  using namespace std;
	...
	//char* rootFile = "plotsPaperGEN_eta20.root";
        char* rootFile = "basic.root";
	//char* curvesCSVfile = "Tune_CUETP8M1_PTmax_Eta20.csv";
	char* curvesCSVfile2 = "13-10-23-60256-GEN_Monash_PTmax_Eta20_7-27-15.csv";
	char* curvesCSVfile = "13-10-23-1903-GEN_CUETP8M1_PTmax_Eta20_7-27-15.csv";
	cout << "Loading ROOT file            " << rootFile << endl;
	cout << "Loading CSV file             " << curvesCSVfile << endl;
	cout << "Loading another CSV file     " << curvesCSVfile2 << endl;

        //cout << "Currently plotting SIM vs Rick Curves!!!" << endl;
	TFile *fhist = new TFile(rootFile);
        //TFile *fsave = new TFile("curves.root","RECREATE");


	double etaCut = 2.0;
	cout << "Current etaCut (if doing any scaling) is " << etaCut << endl;
	...
	//scaleThird = 1;
	//scaleSixth = 1;
	cout << "Scale factors:" << scaleTotal << " " << scaleThird << " " << scaleSixth << endl;
...
//f00->Cd("MinBias_TuneMonash13_13TeV_pythia8");
    ...
    TH1D *d=(TH1D*) fhist->Get("transDIF_nch");
...
//MinBias_TuneMonash13_13TeV_pythia8
...
//TH2F* da2=(TH2F*) f01->Get("MinBias_TuneMonash13_13TeV_pythia8/gen_nTrans_SisCone5");
    ...
    //TGraph *g = new TGraph(curvesCSVfile,   "%lg,%*lg,%*lg,%*lg,%*lg,%*lg,%lg");
    //TGraph *g2 = new TGraph(curvesCSVfile2, "%lg,%*lg,%*lg,%*lg,%*lg,%*lg,%lg");
    //TGraph *g = new TGraph(curvesCSVfile,   "%lg,%*lg,%*lg,%*lg,%*lg,%*lg,%*lg,%lg");
    //TGraph *g2 = new TGraph(curvesCSVfile2, "%lg,%*lg,%*lg,%*lg,%*lg,%*lg,%*lg,%lg");
    //TGraph *g = new TGraph(curvesCSVfile,   "%lg,%*lg,%*lg,%*lg,%*lg,%lg");
    //TGraph *g2 = new TGraph(curvesCSVfile2, "%lg,%*lg,%*lg,%*lg,%*lg,%lg");
    TGraph *g = new TGraph(curvesCSVfile,   "%lg,%*lg,%*lg,%*lg,%*lg,%*lg,%*lg,%*lg,%lg");
    TGraph *g2 = new TGraph(curvesCSVfile2, "%lg,%*lg,%*lg,%*lg,%*lg,%*lg,%*lg,%*lg,%lg");
...
//
   ...
   // nTrans_SisCon5->Draw();	
    ...
    //latexLabel2.DrawLatex(0.4, 0.93, "transMAX charged particle density");
    //latexLabel2.DrawLatex(0.4, 0.93, "transMIN charged particle density");
    //latexLabel2.DrawLatex(0.4, 0.93, "transAVE charged particle density");
    latexLabel2.DrawLatex(0.4, 0.93, "transDIF charged particle density");
    ...
    TLegendEntry *pleee = pl->AddEntry(g2, "Monash",  "L");
    pl->Draw();
    //gPad->RedrawAxis();
    //c1->SaveAs("curvePlots_1vtx/UE_nchTransMAX.png");
    //c1->SaveAs("curvePlots_1vtx/UE_nchTransMIN.png");
    //c1->SaveAs("curvePlots_1vtx/UE_nchTransAVE.png");
    c1->SaveAs("curvePlots_1vtx/UE_nchTransDIF.png");
